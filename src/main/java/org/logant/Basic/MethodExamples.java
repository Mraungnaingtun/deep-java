...
public class MethodExamples {
    ...
    // ---------------------------------------------------
    // 8. Accessor (Getter) and Mutator (Setter) Methods - access and modify private
    // fields
    private String name;
    ...
    interface Greeting<T> {
        ...
        default void show(int a){
            System.out.format("Demo of default method %d\n" , a);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(MethodExamples.ConcreteClass.staticValue);
        ...
        // expression!");
        // greeting.sayHello();
        Greeting<String> greeting = (name) -> System.out.println("Hello, " + name + "!");
